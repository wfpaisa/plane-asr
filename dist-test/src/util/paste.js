...
export function pasteAtCursor(text) {
    ...
    return new Promise(resolve => {
        ...
        clipboard.get_text(St.ClipboardType.CLIPBOARD, (cb, previousText) => {
            ...
            keyboard.notify_keyval(timeUs, Clutter.KEY_Control_L, Clutter.KeyState.PRESSED);
            keyboard.notify_keyval(timeUs, Clutter.KEY_v, Clutter.KeyState.PRESSED);
            keyboard.notify_keyval(timeUs, Clutter.KEY_v, Clutter.KeyState.RELEASED);
            keyboard.notify_keyval(timeUs, Clutter.KEY_Control_L, Clutter.KeyState.RELEASED);
