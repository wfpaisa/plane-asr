 ...
 */
export function downloadedCliPath(version = ENGINE_MANIFEST.version) {
 ...
 */
export function downloadedCliAvailable(version = ENGINE_MANIFEST.version) {
 ...
 */
export function resolveAutoCli(pathName) {
