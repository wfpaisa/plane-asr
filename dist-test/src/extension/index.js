...
export default class PlaneAsrExtension extends Extension {
    ...
    enable() {
        ...
        this._service = new AsrService(this._settings, (state, ctx) => this._indicator?.onStateChanged(state, ctx), { extensionDir: this.path });
        this._indicator.service = this._service;
        this._indicator.bind(this._settings);
        Main.panel.addToStatusArea(this.uuid, this._indicator);
        Main.wm.addKeybinding(SETTINGS_KEYS.TOGGLE_RECORD_SHORTCUT, this._settings, Meta.KeyBindingFlags.NONE, Shell.ActionMode.ALL, () => {
