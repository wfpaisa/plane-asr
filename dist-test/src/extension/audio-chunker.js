...
import { BYTES_PER_SAMPLE, SAMPLE_RATE, buildWavHeader, wavDataOffsetFromHeader, } from '../util/wav.js';
export { SAMPLE_RATE };
/**
 ...
 * los primeros KiB.
 */
export function getWavDataOffset(path) {
    let head;
    try {
 ...
 */
export function wavAvailableSamples(path, dataOffset) {
 ...
 */
export function writeWavChunk(srcPath, dataOffset, sampleStart, sampleCount, outPath) {
    ...
    Gio.File.new_for_path(outPath).replace_contents(out, null, false, Gio.FileCreateFlags.REPLACE_DESTINATION, null);
}
/**
...
//# sourceMappingURL=audio-chunker.js.map